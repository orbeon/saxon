    ...
    public int next() throws XPathException {
        ...
        try {
            ...
            if (!e.hasBeenReported()) {
                try {
                    context.getController().getErrorListener().fatalError(e);
        ...
        while (true) {
            ...
            if (next == null) {
                ...
                if (kind == Type.ATTRIBUTE) {
                    if (!foundAttributes) {
                        if (attributes == null) {
                            attributes = new AttributeCollectionImpl(context.getController().getNamePool());
                        }
                        attributes.clear();
                    ...
                    if (index >= 0) {
                        ...
                        if (context.getController().getExecutable().getHostLanguage() == Configuration.XSLT) {
                            attributes.setAttribute(index,
                                    node.getNameCode(),
                                    preserve ? node.getTypeAnnotation() : -1,
