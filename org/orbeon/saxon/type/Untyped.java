...
public final class Untyped extends SchemaType implements ComplexType {
    ...
    private Untyped() {
        super();
        try {
            setBaseType(AnyType.getInstance());
            setBaseTypeFingerprint(getBaseType().getFingerprint());
        } catch (SchemaException e) {
            throw new AssertionError("Failed to initialize xdt:untyped");
        }
    }
    ...
    public int relationshipTo(SchemaType other) {
        ...
        } else if (other instanceof Untyped) {
