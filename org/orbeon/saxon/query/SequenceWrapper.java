...
public class SequenceWrapper extends SequenceReceiver {
    ...
    public void open() throws XPathException {
        ...
        out.startElement(resultSequence, -1, 0, 0);
    ...
    public void startDocument(int properties) throws XPathException {
        out.startElement(resultDocument, -1, 0, 0);
        out.startContent();
        depth++;
    }
    ...
    public void startElement(int nameCode, int typeCode, int locationId, int properties) throws XPathException {
        if (depth++ == 0) {
            out.startElement(resultElement, -1, 0, 0);
            out.startContent();
        }
    ...
    public void attribute(int nameCode, int typeCode, CharSequence value, int locationId, int properties) throws XPathException {
        if (depth==0) {
            out.startElement(resultAttribute, -1, 0, 0);
    ...
    public void namespace(int namespaceCode, int properties) throws XPathException {
        if (depth == 0) {
            out.startElement(resultNamespace, -1, 0, 0);
    ...
    public void characters(CharSequence chars, int locationId, int properties) throws XPathException {
        if (depth==0) {
            out.startElement(resultText, -1, 0, 0);
            out.startContent();
    ...
    public void comment(CharSequence chars, int locationId, int properties) throws XPathException {
        if (depth==0) {
            out.startElement(resultComment, -1, 0, 0);
            out.startContent();
    ...
    public void processingInstruction(String target, CharSequence data, int locationId, int properties) throws XPathException {
        if (depth==0) {
            out.startElement(resultPI, -1, 0, 0);
            out.startContent();
    ...
    public void append(Item item, int locationId, int copyNamespaces) throws XPathException {
        if (item instanceof AtomicValue) {
            NamePool pool = getNamePool();
            out.startElement(resultAtomicValue, -1, 0, 0);
            ...
            out.attribute(xsiType, -1, displayName, 0, 0);
            out.startContent();
